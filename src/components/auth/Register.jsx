        ...
        <div className="mx-auto grid w-full max-w-[1200px] grid-cols-1 items-center gap-y-10 px-6 py-12 md:grid-cols-12 md:gap-6 md:py-8">
          ...
          <section className="w-full md:col-start-2 md:col-span-5">
            <h1 className="text-[36px] font-semibold leading-[1.1] tracking-[-0.9px]">
              Register for Campus Resource
            </h1>

            <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
              <div>
                <label className="mb-2 block text-[14px] leading-[1.5]" htmlFor="username">
                  Username
                </label>
                <input
              ...
              <div>
                <label className="mb-2 block text-[14px] leading-[1.5]" htmlFor="confirmPassword">
                  Confirm Password
                </label>
                <input
                  autocomplete="new-password"
          ...
          <figure className="hidden md:col-start-8 md:col-span-5 md:block">
            <img
              alt="University students on campus sharing items"
              className="h-[560px] w-full rounded-[14px] border border-[#eceae4] object-cover object-center shadow-sm"
              src="https://images.pexels.com/photos/7054526/pexels-photo-7054526.jpeg?auto=compress&cs=tinysrgb&w=900&q=80"
              decoding="async"
              loading="lazy"
            />
          </figure>
